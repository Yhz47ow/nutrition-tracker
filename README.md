...
| 功能 | 说明 |
|------|------|
| 🔍 小程序食物库 | 213 种中国常见基础食材，支持膳食类别、汉字和拼音首字母筛选，全程离线 |
| 🍲 家常菜分解 | 24 道常见菜配方，实时累加整菜营养并允许调整每项食材用量 |
| 📝 自定义食物 | 按每份克重和营养创建、编辑、删除食物，支持 kcal/kJ 换算 |
| 🍱 收藏与套餐 | 收藏常用食物，组合自定义套餐并一次拆分记录整餐 |
| 📊 碳蛋脂分析 | 每餐 + 每日的碳水/蛋白质/脂肪比例，环形图直观展示 |
| 📅 历史记录 | 每天饮食记录自动保存，可回顾任意一天 |
| 🏋️ 力量训练 | 预设六大肌群动作、自定义动作、多动作与多组记录 |
| 🗓️ 手动训练计划 | 月历安排训练日和休息日，自由填写训练内容与备注 |
| 🎯 训练/休息日饮食 | 分别设置两类营养目标，按训练计划日期自动套用 |
| 🔁 自定义饮食周期 | 自定义 1-31 天热量与碳蛋脂比例，支持循环和今日覆盖 |
...
### 🔍 小程序食物库
- **基础食材**：从 213 种本地中国常见食材中选择，可按膳食类别筛选
- **家常菜**：选择内置菜肴后按实际情况调整食材比例，再拆分记录
- **常用**：点击星标收藏后快速选择
- **我的食物**：你自定义添加的食物
- **我的套餐**：一次记录套餐内的全部组成食物
- 点击食物 → 输入克数 → 选择餐次 → 添加记录
...
2. 查看包装上的「营养成分表」
3. 填入包装标示的 **每份** 热量/碳水/蛋白/脂肪；热量可选择 kcal 或 kJ
4. 「每份克重」填这份食品的实际重量
5. 保存后会在「我的食物」中出现
...
- 微信小程序食物查询完全本地化，不会发送网络请求
- 只有用户主动执行 GitHub Gist 上传或配置可选同步后端时，数据才会离开本机

## 👨‍🍳 小贴士

- **速食产品**：看包装背面「营养成分表」，按每份填入自定义食物
